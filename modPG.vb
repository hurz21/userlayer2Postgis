...
Module modPG
  ...
  art & "','" &
    ...
    Function getUserebeneAid(username As String, ByRef useridINtern As Integer, ByRef mac As String) As Integer
        Dim sql As String
        Dim userlayeraid As Integer
        Dim erfolg As Boolean
        Try
    ...
    Friend Function InsertInNutzertabAid(username As String, userEbeneAid As Integer, mac As String) As Integer
        Dim sql As String
        Dim userlayeraid As Integer
        Dim erfolg As Boolean
        Try
            ...
            dtRBplus = New DataTable
            sql = "insert into public.nutzer (name,userlayeraid,pruef) " &
